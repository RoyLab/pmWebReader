...
MyRemarkEditor = Ext.extend(Ext.form.Field, {
    /**
    ...
    onRender : function(ct, position){
        MyRemarkEditor.superclass.onRender.call(this, ct, position);
    ...
    onResize : function(w, h){
        MyRemarkEditor.superclass.onResize.apply(this, arguments);
    ...
    setValue : function(v){
        MyRemarkEditor.superclass.setValue.call(this, v);
        this.pushValue();
    },
    ...
    getValue : function() {
        this.syncValue();
        return MyRemarkEditor.superclass.getValue.call(this);
    },
    ...
    // private
    initEditor : function(){
        //wuqifeng 修正在win2000环境下，浏览器设置为"允许脚本调试"情况写没有权限的问题-------------
        try{
...
Ext.reg('htmleditor', MyRemarkEditor);