...
Ext.extend(MainFrame.FramePanel,Ext.ux.ManagedIframePanel, {
    afterRender : function(container){
            ...
            if(ApplicationContext.UserInfo.ShowDmc)
            {
            ...
            this.bottomToolbar.add(this.m_btnAfiLogicTable);
    ...
    initComponent : function(){
        MainFrame.FramePanel.superclass.initComponent.call(this);
                ...
                this.m_btnAfiMode = new Ext.Toolbar.Button({ id: 'm_btnAfiMode', hidden : true,text: '开始隔离',  icon: 'resources/images/16x16/play.png', cls: 'x-btn-text-icon', tooltip: '<b>开始隔离</b><br/>开始隔离当前选中的故障',enableToggle: true ,toggleHandler: this.m_frameHandler.FrameToolBar_Click});
                ...
                this.m_btnAfiLogicTable = new Ext.Toolbar.Button({ id: 'm_btnAfiLogicTable', text: '故障逻辑表', hidden:true, icon: 'resources/images/16x16/Outline.png', cls: 'x-btn-text-icon', tooltip: '<b>故障逻辑表</b><br/>显示故障逻辑', handler: this.m_frameHandler.FrameToolBar_Click});
