 ...
 * @param {xyTree.Node} node 待添加的一级节点
 */
xyTree.Tree.prototype.SetSelectNode = function(node) {

  if (this.selectNode!=undefined && this.selectNode.getHtmlElement()!=undefined) 
      this.selectNode.getHtmlElement().firstChild.style.backgroundColor="";
  this.selectNode=node;
  if (this.selectNode!=undefined && this.selectNode.getHtmlElement()!=undefined) 
      this.selectNode.getHtmlElement().firstChild.style.backgroundColor="#d9e8fb";
}
