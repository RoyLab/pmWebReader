...
<div class="easyui-menu" id="mm5">
	...
	<div class="tool">
	<img id="hide" src="themes/icons/NavPane.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="显示/隐藏" />
	<img id="home2" src="themes/icons/Home.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="首页" />
	<img id="back2" src="themes/icons/Back.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="后退" />
	<img id="forward2" src="themes/icons/Next.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="前进" />
	<img id="media" src="themes/icons/MultimediaViewer.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="多媒体" />
	<img id="remarks2" src="themes/icons/Remark.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="备注" />
	<img id="exportremarks2" src="themes/icons/ExportRemark.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="导出备注" />
	<img id="addcomment" src="themes/icons/AddComments.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="添加意见" />
	<img id="viewcomment" src="themes/icons/Comments.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="查看意见" />
	<img id="exportdmfiles" src="themes/icons/ExportDM.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="导出DM文件" />
	<img id="print2" src="themes/icons/print.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="打印" />
	<img id="applicability2" src="themes/icons/Applic.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="适用性" />
	<img id="maintaintask" src="themes/icons/PlanReport.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="维护任务" />
	<img id="lock" src="themes/icons/Lock.png" class="tools easyui-linkbutton easyui-tooltip" data-options="plain:true" title="锁定" />
	</div>
	<div class="main easyui-layout">
		<div id="left" class="leftpart" data-options="region:'west',split:true" title="导航">
			<div class="easyui-accordion" data-options="fit:true,border:false">
				<div id="left1" title="导航树" style="padding:10px;">
		...
		<div data-options="region:'center'">
			<div id="center" class="easyui-tabs" data-options="fit:true,border:false,plain:true">
				<div id="center1" title="首页" style="padding:10px">
